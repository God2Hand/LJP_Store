								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											<c:if test="${not empty ljp_super }">
												<font color="red" >超级管理员：</font>
											</c:if>
											<c:if test="${empty ljp_super }">
												管理员：
											</c:if>
											<font color="blue">${admin.mname }</font>
											&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath}/manager?method=mlogout" target="_top" >
												<font color="blue"><u>注销</u></font>
											</a>
										</td>
